                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td bgcolor="#ffffff" align="left"
                                        ...
                                        <p style="margin: 0;">We're excited to have you get started. First, you need to
                                            confirm your account. Just press the button belowI.</p>
                                    </td>
                                </tr>
                            </table>
                        </div>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td align="center" style="border-radius: 3px;" bgcolor="#FFA73B"><a
                                                        href="http://localhost:3000/email_verification/${verifyToken}" target="_blank"
                                                        style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 20px 25px; border-radius: 2px; border: 1px solid #62CF6F; display: inline-block; background-color: #62CF6F">Confirm
                                                    Account</a></td>
                                            </tr>
                                            </tbody>
                                        </table>
